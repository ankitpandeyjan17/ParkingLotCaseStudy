...
public interface BookingTools extends ToolsFactory {
	public abstract Booking confirmBooking(Customer customer,ParkingSpot spot,VehicleType vehicleType,String vehicleNumber,boolean royalPark,boolean customerPooled);
